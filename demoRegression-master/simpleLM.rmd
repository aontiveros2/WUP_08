...
The best model is based on HEADLEN as seen by the adjusted R-squared, the prediction of the length for bears 5, 15, 23 is   
70.31, 51.94, 58.83.    

The actual lengths of the bears was  
`r bears$LENGTH[c(5, 15, 23)]`. 

The error in prediction for bear number 5 is about 8 inches, for bear number 15 the prediction is on point, for bear number 23 the error in prediction is just under 6 inches. 
